...
.section-kicker, .panel-label { color: var(--muted); font-size: 10px; letter-spacing: 1.5px; font-weight: 700; }
...
.variant-badge, .section-count { color: var(--accent-ink); background: var(--surface-muted); border-radius: 20px; padding: 6px 10px; font-size: 10px; font-weight: 700; letter-spacing: .5px; white-space: nowrap; }
.workspace { display: grid; grid-template-columns: 190px minmax(0, 1fr); gap: 42px; }
.sidebar-panel { border-right: 1px solid var(--line); padding-right: 20px; }
.sidebar-panel nav { margin-top: 14px; }
.side-link { display: flex; justify-content: space-between; align-items: center; padding: 10px; margin: 4px 0; color: var(--muted); text-decoration: none; font-size: 12px; border-left: 2px solid transparent; }
.side-link:hover { color: var(--brand-soft); border-left-color: var(--focus); background: var(--surface-muted); }
...
.knowledge-section { border-top: 1px solid var(--line); padding: 34px 0 42px; scroll-margin-top: 20px; }
...
.entry-card { display: flex; flex-direction: column; min-height: 150px; padding: 17px; border: 1px solid var(--line); border-radius: 8px; background: var(--surface); text-decoration: none; transition: border-color .15s, transform .15s; box-shadow: var(--shadow); }
...
.entry-card h4 { color: var(--brand-soft); font: 600 16px 'Space Grotesk'; margin: 8px 0 6px; }
.entry-card p { color: var(--muted); font-size: 12px; line-height: 1.5; margin: 0; }
